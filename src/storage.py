...
def save_session(session_id: str, session_meta: dict, values: dict, visual_labels: dict, review_status: dict):
    ...
    for name in ["metric_definitions_v0_4_5.json", "metric_definitions_v0_4.json", "metric_definitions_v0_3.json", "metric_definitions_v0_2.json", "metric_definitions_v0_1.json"]:
